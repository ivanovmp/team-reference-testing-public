...
cat "./FFT/testing/Timus.1996. Cipher Message 3/pre_ntt.cpp" ./utils/typedefs.hpp ./basic_strings/z_function.hpp ./number_theory/modulo.hpp ./FFT/NTT.hpp "./FFT/testing/Timus.1996. Cipher Message 3/post_ntt.cpp" > ./temp/code_ntt.cpp
echo "Trying FFT:"
